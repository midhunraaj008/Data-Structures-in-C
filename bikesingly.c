...
struct bike* deleteNode(struct bike *front)
{
...
printf("Press 2 to delete a bike from the queue \n");
printf("Press 3 to display the entire queue \n");
printf("Press 4 to search the queue \n");
...
case 2: linkList = deleteNode(linkList);
break;
